...
public class DetectorActivity extends CameraActivity implements OnImageAvailableListener {
  ...
  private static final float MINIMUM_CONFIDENCE_TF_OD_API = 0.62f;
    ...
    runInBackground(
        new Runnable() {
          ...
          public void run() {
            ...
            //grab objects recognized and look for persons
            Boolean person_seen = false;
            for (int i = 0; i < mappedRecognitions.size(); i++){
              if (mappedRecognitions.get(i).getTitle().equals("person")) {
                personDetected(mappedRecognitions.get(i));
                person_seen = true;
                break;
              }
            }
